...
ds='Алмазный щит. При наличии, имеет шанс отразить любую, кроме алмазной, пулю в стрелявшего. Этот щит нельзя сломать.'
            ...
            if m.reply_to_message!=None:
                try:
                    ...
                    if user2!=None:
                        ...
                        if d_shield==True and random.randint(1,100)<=d_chance and bullet != 'diamond_bullet':
